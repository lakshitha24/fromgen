...
(function ($) {
  ...
  //   e.preventDefault();
   ...
   //  console.log(image);
     ...
     $.ajax({
    type : 'post',
    url : 'function/function-createForm.php',
    data :  { formID:formID ,xml:xml1,image:image },
  ...
  //  console.log(response);
   ...
   // $('#fist-frame').hide();
      ...
      var userID = $('#userID').text();
        ...
        $.ajax({
          type:'post',
          url:'function/function-update.php',
          data:{userID:userID, formID:formID ,xml:xml1 , image:image},
          success :function(response){
            console.log(response);
          }
